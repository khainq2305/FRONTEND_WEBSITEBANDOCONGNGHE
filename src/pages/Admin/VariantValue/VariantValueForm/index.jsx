...
const VariantValueForm = () => {
  ...
  return (
    <Paper sx={{ width: '100%', p: 3, opacity: isLoading ? 0.7 : 1 }}> 
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}> 
          ...
          {variantType === 'color' && (
            <Controller
              ...
              render={({ field }) => (
                <Box>
                  <Typography variant="subtitle2" gutterBottom>Chọn màu</Typography>
                  <ChromePicker
          ...
          {variantType === 'image' && (
            <Controller
              ...
              render={({ field, fieldState }) => (
                <>
                  <Typography variant="subtitle2" gutterBottom>Ảnh hiển thị</Typography>
                  <Box
                    component="label"
