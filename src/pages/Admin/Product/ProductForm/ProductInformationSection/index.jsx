...
import { 
    Grid, TextField, Typography, MenuItem, FormHelperText,
...
const badgeOptions = [
    ...
    { label: "Độc quyền Online", value: "ĐỘC QUYỀN ONLINE" }
];
        ...
        categories.forEach((cat, index) => {
            ...
            options.push(
                <MenuItem key={cat.id} value={cat.id} sx={{ pl: level * 2 }}>
                    <span style={{ whiteSpace: 'pre' }}>{currentPrefix}</span>{cat.name}
                </MenuItem>
            );
        ...
        <>
            ...
            <Grid item xs={12} md={4}>
                ...
                {formErrors.thumbnail && (
                    <FormHelperText error sx={{ ml: 2, mt: 1 }}>{formErrors.thumbnail}</FormHelperText>
                )}
