// // ProductCategorySlider.js
// import React, { useState, useEffect, useRef } from 'react';
// import Slider from "react-slick";

// import "slick-carousel/slick/slick.css";
// import "slick-carousel/slick/slick-theme.css";
// import './ProductCategorySlider.css'; // Đảm bảo tên file CSS khớp
...
//       {/* CSS của bạn sẽ xử lý line-clamp cho tên sản phẩm */}
...
//   mainSectionTitle = "SẢN PHẨM NỔI BẬT"
// }) => {
//   
...
//     dots: false,
//     infinite: true, // Đặt true để cuộn vô hạn, giúp slidesToScroll: 1 ổn định hơn
//     speed: 500,
//     slidesToShow: 5, 
//     slidesToScroll: 1, // Luôn cuộn 1 cột mỗi lần click/autoplay
//     arrows: true, 
//     autoplay: true, // Kích hoạt autoplay
//     autoplaySpeed: 5000, // Thời gian giữa các lần tự động chuyển slide (5 giây)
...
//         settings: { 
//             slidesToShow: 4, 
//             slidesToScroll: 1, // Luôn là 1
//             arrows: currentProducts.length > 4, // Điều kiện hiển thị arrows
//             infinite: true // Đảm bảo infinite
//         }
//       },
//       {
//         breakpoint: 1023, 
...
//         breakpoint: 479, 
//         settings: { 
//           slidesToShow: 1.5, // Giữ 1.5 hoặc 1.6 để card rộng hơn trên mobile rất nhỏ
//           slidesToScroll: 1, // Luôn là 1
//           arrows: false, 
//           infinite: true 
//         }
...
//             {mainSectionTitle}
//           </h1>
//           <div className="hidden md:flex flex-wrap items-center gap-x-1.5 gap-y-1.5">
...
//         ) : (
//         // Class của Slider nên khớp với CSS của bạn, ví dụ "fresh-slick-slider"
