...
// import useFavorites from '../../../hooks/useFavorites'; // ĐÃ XÓA
import { bannerService } from '../../../services/client/bannerService';
import { flashSaleService } from '../../../services/client/flashSaleService';
// import { wishlistService } from '../../../services/client/wishlistService'; // CÓ THỂ XÓA NẾU KHÔNG DÙNG NƠI KHÁC
...
const HomePage = () => {
    ...
    // const { isFavorite, toggleFavorite } = useFavorites(); // ĐÃ XÓA
    ...
    const originalPrice = sku.originalPrice || 0; // Đây là giá gốc của SKU
    const salePrice = item.salePrice || 0; // Đây là giá Flash Sale
    ...
    return {
        ...
        slug: product.slug,
        price: formatCurrencyVND(salePrice), // Giá chính hiển thị (giá Flash Sale)
        // DÒNG ĐÃ SỬA: Gán giá gốc vào 'oldPrice' để InlinedProductCard hiển thị gạch ngang
                    ...
                    const productsForSlider = section.products
                        .map((product) => {
                            ...
                            return {
                                ...
                                // isFavorite: isFavorite(product.id) // ĐÃ XÓA
                            };
                        })
                        .filter((p) => p && p.id);
                    ...
                    return (
                        <section key={section.id}>
                            <FreshProductSlider
                                ...
                                // onToggleFavorite={toggleFavorite} // ĐÃ XÓA
