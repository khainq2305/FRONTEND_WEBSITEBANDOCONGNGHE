...
const InlinedProductCard = ({
    ...
    // Hàm chuyển đổi giá trị string thành số để tính toán
    ...
    // ✅ HÀM RENDER BADGE ĐÃ SỬA
    const renderBadge = () => {
        if (!badge) {
            // Luôn trả về một div giữ chỗ có chiều cao bằng với huy hiệu
        ...
        // Trả về div giữ chỗ nếu không tìm thấy ảnh phù hợp
        return <div className="mb-2 h-[28px]"></div>;
    };
                    ...
                    <div className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1">
                        {linkedCategories.slice(0, 5).map((cat) => (
                            <Link
                                ...
                                className="text-[13px] sm:text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 px-2.5 py-1 rounded-full shadow-sm border border-gray-300 transition"
                            >
                                {cat.name}
                            </Link>
                        ))}
                        {linkedCategories.length > 5 && (
                            <Link
                                to="/danh-muc"
                                className="text-[13px] sm:text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full shadow-sm border border-blue-200 transition"
                            >
                                Xem tất cả
                            </Link>
                        )}
