      ...
      <div className="flex items-center justify-between flex-wrap gap-2 p-3 sm:p-4">
        ...
        <div className="text-right">
          {item.originalPrice > item.finalPrice && (
            <p className="text-gray-400 text-xs line-through">{formatCurrencyVND(item.originalPrice)}</p>
          )}

          <p className="text-red-600 font-bold text-sm md:text-base">{formatCurrencyVND(item.finalPrice)}</p>
        </div>
