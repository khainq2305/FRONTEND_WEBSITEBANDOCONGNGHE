...
import tacgia from '../../../../assets/Client/images/News/lan-huong-1.jpg';
import anh1 from '../../../../assets/Client/images/News/ra-mat-galaxy-s25-edge-1-2.jpg';
    ...
    return (
        <div className="">
            ...
            <p className="mb-4 text-justify">
                ...
                “quân bài chiến lược” để đối đầu với iPhone 17 “Air” mà Apple dự kiến trình làng vào năm sau.
            </p>

            <h2 className="font-semibold text-lg mb-2 text-justify">
            ...
            <p className="mb-4 text-justify">
                ...
                khiến nó trở thành mẫu điện thoại mỏng nhất của hãng từ trước đến nay.
                Khi so sánh, iPhone 17 Air được đồn đoán sẽ mỏng hơn (5,5mm)
            ...
            <p className="mb-4 text-justify">
                ...
                một chất liệu vốn chỉ xuất hiện ở những mẫu cao cấp như
                Galaxy S25 Ultra hoặc iPhone Pro Max.
            </p>
            ...
            <p className="mb-4 text-justify">
                ...
                trong điều kiện thiếu sáng. Trong khi đó, iPhone 17 Air được
                cho là chỉ trang bị camera đơn 48MP, điều này tạo nên lợi thế
            ...
            <div className="mb-4 text-justify">
                ...
                <ul className="list-disc pl-5 text-sm space-y-1">
                    <li>Drawing Assist: hỗ trợ vẽ bằng AI</li>
                    <li>Audio Eraser: xóa tạp âm khi quay video</li>
                    <li>ProScaler: nâng cao chất lượng ảnh bằng công nghệ AI</li>
                    <li>Now Brief & Now Bar: cập nhật thông tin thông minh từ nhiều nguồn</li>
                </ul>
            </div>
            ...
            <p className="mb-4 text-justify">
                ...
                Samsung đã triển khai chương trình đặt hàng trước với mức giá khởi
            ...
            <p className="mb-4 text-justify">
                ...
                thiết kế ấn tượng, camera hàng đầu và tính năng AI toàn diện,
                S25 Edge là lựa chọn hấp dẫn cho những ai yêu thích công nghệ tiên
            ...
            <div className="mb-4 text-justify">
                ...
                <ul className="list-disc pl-5 text-sm space-y-1">
                    ...
                    <li>Trên tay Galaxy S25 Edge: Mỏng ấn tượng, camera 200MP, giá từ 1.099 USD</li>
                    <li>Đánh giá Samsung Galaxy S25: có xứng đáng sở hữu năm 2025</li>
                </ul>
            </div>
            ...
            <div className="mb-4 text-justify">
                ...
                <ul className="list-disc pl-5 text-sm space-y-1">
                    ...
                    <li>1247, Đường 3 Tháng 2, P7, Quận 11, HCM</li>
