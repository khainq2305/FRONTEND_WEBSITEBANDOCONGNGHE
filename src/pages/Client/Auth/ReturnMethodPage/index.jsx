...
import { Box, Button, RadioGroup, Radio, TextField, CircularProgress, Chip, Typography, Link, Menu, MenuItem, Paper } from '@mui/material';
...
export default function ReturnMethodPage() {
  ...
  const RenderDefaultChip = ({ isDefault }) => {
    ...
    return <Chip label="Mặc định" size="small" color="default" sx={{ ml: 1, whiteSpace: 'nowrap', flexShrink: 0 }} />;
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (returnMethod === 'ghn_pickup') {
        ...
        await returnRefundService.createDropoffReturnOrder(returnRequestIdFromDetails, {
    ...
    <>
      <Paper sx={{ p: { xs: 2, sm: 3 }, borderRadius: 3, mt: 3, mb: 5 }}>
            ...
            >
              ...
              >
                ...
                <Box sx={{ flexGrow: 1, pt: '16px', pb: '16px', pr: '16px' }}>
                      ...
                      >
                        ...
                        >
                          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                            ...
                            {selectedPickupAddress && selectedPickupAddress.isDefault && <RenderDefaultChip isDefault={true} />}
                          </Box>
                          ...
                          >
                            {selectedPickupAddress?.streetAddress}, {selectedPickupAddress?.ward?.name},{' '}
                            {selectedPickupAddress?.district?.name}, {selectedPickupAddress?.province?.name}
                          </Typography>
                        </Box>
                  ...
                  {/* PHẦN ĐƠN VẬN CHUYỂN */}
                  <Box className="relative mb-4" sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                    {/* Bên trái */}
                ...
                <Box sx={{ flexGrow: 1 }}>
                  ...
                  >
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ width: '100%', mt: 0.5, ml: 0.5 }}>
                      ...
                      <span style={{ color: '#1AA2E9', cursor: 'pointer' }}> Bấm để xem địa chỉ gần nhất.</span>
                    </Typography>
                  </Box>
        ...
        <Box sx={{ mt: 4, display: 'flex', justifyContent: 'flex-end', gap: 1, pt: 2, borderTop: '1px solid #e0e0e0' }}>
          <Button onClick={handleCancelRequest} variant="outlined" color="primary" disabled={loading}>
