                  ...
                  <li key={item.id} className="mb-0">
                    {item.subItems ? (
                      <>
                        ...
                        <div
                          className={`flex items-center py-2.5 px-3 rounded-md text-sm relative ${parentIsActive ? 'text-primary' : 'text-gray-800 dark:text-gray-200 hover:text-sky-500 dark:hover:text-sky-400'}`}
                        >
                          {item.icon && (
                            <item.icon
                              size={18}
                              className={`mr-3 flex-shrink-0 ${parentIsActive ? 'text-primary' : item.iconColor || 'text-gray-600 dark:text-gray-400'}`}
                            ...
                            <li key={subItem.id} className="relative">
                              ...
                              >
                                ...
                                {activeTab === subItem.id && (
                                  <span className="absolute left-[-1.1rem] top-0 bottom-0 w-[3px] bg-primary rounded-r-sm"></span>
                                )}
                                {subItem.label}
                              </a>
                            </li>
        ...
        <div className="flex flex-row">
          ...
          <div className="flex-1 min-w-0 lg:pl-8 md:pl-6 pl-2">
            ...
            {activeTab === 'doi-mat-khau' && (
              <div className="bg-white dark:bg-gray-800 p-6 shadow-md rounded-md border border-gray-200 dark:border-gray-700">
                <h2 className="text-xl font-semibold dark:text-gray-100">Đổi Mật Khẩu</h2>
                <p className="text-sm dark:text-gray-300">Nội dung trang Đổi Mật Khẩu...</p>
              </div>
            )}
            ...
            {activeTab === 'kho-voucher' && (
              <div className="bg-white dark:bg-gray-800 p-6 shadow-md rounded-md border border-gray-200 dark:border-gray-700">
                <h2 className="text-xl font-semibold dark:text-gray-100">Kho Voucher</h2>
                <p className="text-sm dark:text-gray-300">Nội dung trang Kho Voucher...</p>
              </div>
            )}
