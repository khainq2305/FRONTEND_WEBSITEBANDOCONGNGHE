...
import emptyOrderImage from '@/assets/Client/images/empty-order.png';
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between">
        ...
        ${
          address.label.toLowerCase() === 'nhà riêng'
            ? 'bg-yellow-200 text-yellow-900'
            : address.label.toLowerCase() === 'văn phòng'
              ? 'bg-blue-200 text-blue-900'
              : address.label.toLowerCase() === 'nhà người yêu'
    ...
    <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 shadow-sm rounded-md border border-gray-200 dark:border-gray-700 min-h-[calc(100vh-150px)]">
      ...
      {loading && addresses.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-10 text-gray-500 dark:text-gray-400">
          <img src={emptyOrderImage} alt="No address" className="w-40 h-40 mb-4 object-contain" />
