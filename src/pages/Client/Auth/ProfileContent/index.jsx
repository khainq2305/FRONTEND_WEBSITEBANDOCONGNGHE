      ...
      <div className="bg-white p-6 shadow-md rounded-md border border-gray-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-10 gap-y-6">
          <form className="lg:col-span-2 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-[110px_1fr] items-center gap-4">
              <label htmlFor="fullName" className="text-sm text-gray-500 text-right pr-2">
                Họ và Tên
              </label>
              <div>
                <input
            ...
            <div className="grid grid-cols-[110px_1fr] items-start gap-4">
              <label htmlFor="phone" className="text-sm text-gray-500 text-right pr-2 pt-2.5">
                Số điện thoại
              </label>
              {isEditingPhone ? (
                <div>
                  ...
                  <div className="flex items-center justify-between gap-x-3 w-full">
                    <div className="flex gap-x-3 flex-1">
                      ...
                      >
                        ...
                        {Array.from({ length: 83 }, (_, i) => String(new Date().getFullYear() - 18 - i)).map((year) => (
          ...
          <div className="lg:col-span-1 flex flex-col items-center pt-3 lg:pt-0 lg:border-l lg:border-gray-200 lg:pl-8">
            ...
            <label
              ...
              className={`cursor-pointer bg-white border border-gray-300/80 text-gray-700 text-sm py-2 px-5 rounded hover:bg-gray-50 transition-colors shadow-sm mb-2.5 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              Chọn Ảnh
            </label>
