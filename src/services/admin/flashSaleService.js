...
export const flashSaleService = {
  updateSortOrder: (slug, list) => patch(`${base}${API_ENDPOINT.admin.flashSale.updateSortOrder(slug)}`, list),
  ...
  getSkus: (params = {}) => get(`${base}${API_ENDPOINT.admin.flashSale.getSkus}`, params),
