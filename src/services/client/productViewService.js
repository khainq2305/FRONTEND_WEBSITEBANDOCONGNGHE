...
export const productViewService = {
  ...
  searchForCompare: (params) => get(`${base}${API_ENDPOINT.client.productView.searchForCompare}`, params),
  ...
  getRecentlyViewedByCategoryLevel1: (categoryId) =>
    get(`${base}${API_ENDPOINT.client.productView.recentlyViewedByCategoryLevel1}?categoryId=${categoryId}`)
};
