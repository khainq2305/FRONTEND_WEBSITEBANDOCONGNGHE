      ...
      <div className="max-w-screen-xl mx-auto"> {/* Container chính giữ max-width và căn giữa */}
          ...
          */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-10">
            ...
            <div className="text-xs sm:text-sm">
              ...
              <p className="mb-1.5"><a href="tel:19008922" className="hover:text-primary">Mua nhanh Online: <strong className="text-primary">1900 8922</strong></a> (8h-24h mỗi ngày)</p>
              <p className="mb-1.5"><a href="tel:19008174" className="hover:text-primary">Bảo hành - Sửa chữa: <strong className="text-primary">1900 8174</strong></a> (8h-21h mỗi ngày)</p>
              <p className="mb-1.5"><a href="tel:0364444247" className="hover:text-primary">Góp Ý/ Phản ánh về DV: <strong className="text-primary">0364 444 247</strong></a> (8h-24h mỗi ngày)</p>
              <p className="mb-3"><a href="mailto:hotro@giakho.vn" className="hover:text-primary">Hỗ trợ khách hàng: <strong className="text-primary">hotro@giakho.vn</strong></a></p>
            ...
            <div className="text-xs sm:text-sm">
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-primary">Hướng dẫn sử dụng Voucher</a></li>
                <li><a href="#" className="hover:text-primary">Chính sách giao nhận - kiểm hàng</a></li>
                <li><a href="#" className="hover:text-primary">Chính sách đổi trả</a></li>
                <li><a href="#" className="hover:text-primary">Chính sách bảo mật thông tin</a></li>
                <li><a href="#" className="hover:text-primary">Chính sách bảo hành</a></li>
                <li><a href="#" className="hover:text-primary">Dịch vụ sửa chữa</a></li>
                <li><a href="#" className="hover:text-primary">Quy định sao lưu dữ liệu</a></li>
            ...
            <div className="text-xs sm:text-sm">
              ...
              <ul className="space-y-2 text-gray-400 mb-6">
                <li><a href="#" className="hover:text-primary">Khách hàng doanh nghiệp (B2B)</a></li>
        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-0">
            <div className="mt-8 pt-5 pb-2 border-t border-gray-700 text-xs text-gray-400">
              ...
              <p className="mb-1">Địa chỉ trụ sở chính: 47/2/16C Bùi Đình Túy, Phường 14, Quận Bình Thạnh, Thành phố Hồ Chí Minh | Email hỗ trợ: <a href="mailto:hotro@giakho.vn" className="text-primary hover:underline">hotro@giakho.vn</a> | Gọi mua hàng: <a href="tel:19008922" className="text-primary hover:underline">1900 8922</a></p>
              <p>Chịu trách nhiệm quản lý nội dung: Vũ Viết Tuấn Anh | Email góp ý: <a href="mailto:ceo@giakho.vn" className="text-primary hover:underline">ceo@giakho.vn</a></p>
            </div>
        </div>
      </div>
    </footer>
